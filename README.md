...
CI](https://github.com/swift-android-sdk/swift-android-sdk/blob/6.1.2/.github/workflows/sdks.yml#L521).
...
the process is similar with adb, [as can be seen on the CI](https://github.com/swift-android-sdk/swift-android-sdk/blob/6.1.2/.github/workflows/sdks.yml#L469).
